...
<!--
  <q-dialog v-model="showCreateJobDialog" :content-css="{minWidth: '80vw', minHeight: '80vh'}">
    <q-layout container style="minWidth: '80vw', minHeight: '80vh'" class="shadow-2 rounded-borders">
